...
* Long press the East face button (:material-gamepad-circle-right:) on a supported game in the gamelist and select *Start a Netplay Game*.
...
* Press ++"Function"++ + the South face button (:material-gamepad-circle-down:) to enter the Retroarch Menu.
* Press the South face button (:material-gamepad-circle-down:) to go up one menu then move down to *Netplay*.
* Select *Refresh Netplay LAN List* and press the East face button (:material-gamepad-circle-right:) to look for games.
