...
* *RGC-Integer-Dramatic-LCD-CRT* applies a custom shader preset based on some of Retro Game Corps' recommendations for a dramatic glow effect for CRT systems and LCD grids for handheld systems. This requires integer scaling in order to render evenly.
* *RGC-Noninteger-Dramatic-LCD-CRT* applies a custom shader preset based on some of Retro Game Corps' recommendations for a dramatic glow effect for CRT systems and LCD grids for handheld systems, but is intended to be used for systems without integer scaling.
