...
* *Retrovibes-480p* is a collection of shaders intended to invoke some nostalgia for grids, blur, and scanlines while maintaining performance on the H700 and A133 chips.  Not intended to be pixel perfect, just a mood. This version is intended for 480p devices.
* *Retrovibes-720p-HMDI* is a collection of shaders intended to invoke some nostalgia for grids, blur, and scanlines while maintaining performance on the H700 and A133 chips.  Not intended to be pixel perfect, just a mood. This version is intended for devices that output HDMI at 720p (most Anbernic devices with mini-HMDI out).
* *Retrovibes-720p* is a collection of shaders intended to invoke some nostalgia for grids, blur, and scanlines while maintaining performance on the H700 and A133 chips.  Not intended to be pixel perfect, just a mood. This version is intended for 720p devices (RGCubeXX).
* *Retrovibes-768p* is a collection of shaders intended to invoke some nostalgia for grids, blur, and scanlines while maintaining performance on the H700 and A133 chips.  Not intended to be pixel perfect, just a mood. This version is intended for 768p devices (Trimui Brick and Brick Hammer).
